...
public class CustomerDaoJdbcTemplateImpl implements CustomerDao {
    ...
    private static final String CREATE_CALLS_TABLE_SQL = "create table CALLS(CALLS_ID integer generated by default as identity (start with 1), " +
    ...
    public Customer getFullCustomerDetail(String customerId) throws RecordNotFoundException {
        ...
        List<Call> call = jdbcTemplate.query("select * from CALLS where CUSTOMER_ID=?", new CallsMapper(), customerId);
    ...
    public void addCall(Call newCall, String customerId) throws RecordNotFoundException {
        jdbcTemplate.update("INSERT INTO CALLS (CUSTOMER_ID, NOTES, TIME_AND_DATE) VALUES (?, ?, ?)",
                customerId, newCall.getNotes(), newCall.getTimeAndDate());
    }
}
...
class CustomerMapper implements RowMapper<Customer> {
    ...
    public Customer mapRow(ResultSet rs, int rowNumber) throws SQLException {
        ...
        return new Customer(id, companyName, notes);
    }
}
...
class CallsMapper implements RowMapper<Call> {
    ...
    public Call mapRow(ResultSet rs, int rowNumber) throws SQLException {
        ...
        Timestamp timestamp = rs.getTimestamp("TIME_AND_DATE");
